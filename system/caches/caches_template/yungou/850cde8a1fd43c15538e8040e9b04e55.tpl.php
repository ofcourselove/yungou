...
<html>
	...
	<body>
        ...
        <div style=" background-color: #FFF; height: 40px; padding-top: 1px; border-bottom: 1px solid #eee;">
    ...
    <script src="<?php echo G_TEMPLATES_JS; ?>/mobile/mui.pullToRefresh.material.js"></script>		<script>
