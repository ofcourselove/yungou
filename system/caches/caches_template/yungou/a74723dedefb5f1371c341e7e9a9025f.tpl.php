...
<style>
		#wuliu_select{ padding:5px 8px; width:80px; background-color:#ca1b38;border-radius:2px;font-family: 微软雅黑; color:#fff; font-size:12px; margin-left:30px; }		
		...
		.listTitle .sdzt b{color: #db3752; font-weight:bold}
		.message{ background:#F0EBEC; border:1px solid #EED7D9; color:#db3752; padding:5px 8px; text-indent:10px;}
