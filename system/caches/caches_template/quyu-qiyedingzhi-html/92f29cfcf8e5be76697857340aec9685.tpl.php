...
<div class="container breadcrumbs"><a href="/">首页</a><span class="sep">/</span><span>账户提现</span></div>
<div class="container">
        ...
        <div class="row">
			...
			<div class="span16">
				<div class="xm-line-box uc-box">
					<div class="box-hd">
						<h3 class="title">账户提现</h3>
						<div class="more">
							<div class="subMenu">
								<a href="javascript:;" class="current" id="linkRecharge">提现申请</a>
								<span class="sep">|</span>
								<a href="javascript:;" class="" id="linkApply">充值到<?php echo _cfg('web_name_two'); ?>账户</a>
							</div>
						</div>
					</div>
<link rel="stylesheet" type="text/css" href="/App/Css/layout-topic.css"/>
